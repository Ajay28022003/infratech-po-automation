  ...
  return (
    <div className="space-y-6 h-full flex flex-col animate-in fade-in duration-500 pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Raw Material & Component Suppliers</h1>
          <p className="text-sm text-slate-500 mt-1 font-medium">
            Master database of sheet metal, switchgear, and electrical component vendors for Infratech FZ LLC.
          </p>
        </div>
      ...
      <Card className="flex-1 flex flex-col overflow-hidden shadow-md">
        <div className="p-4 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row gap-4 justify-between">
          <div className="relative max-w-md w-full">
            ...
            <input 
              type="text"
              placeholder="Search by supplier code, name (e.g. Eaton, Schneider)..."

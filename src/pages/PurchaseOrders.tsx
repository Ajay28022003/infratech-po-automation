  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Customer Purchase Orders</h1>
          <p className="text-xs text-slate-500 mt-1 font-normal">Repository of customer purchase orders across all 4 automation scenarios.</p>
        </div>

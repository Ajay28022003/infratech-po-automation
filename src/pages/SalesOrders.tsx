...
const mockOrders: SalesOrder[] = [
  ...
  { 
    ...
    surcharge: '10% Surcharge (AED 9,752.00)',
    items: [
      { sn: 1, hsCode: '853810009999', coo: 'UAE', itemCode: 'INF-DB-2000-1423-A', description: '2000H x 1423W x 331D Distribution Panel Enclosure IP55 with Mounting Plate & Double Door', qty: 4, unitPrice: 24350.00, total: 97400.00 },
    ]
  },
  { 
    id: 'SO-S00007296', 
    ...
    surcharge: 'Delivery & Surcharge (AED 2,500.00)',
    items: [
      { sn: 1, hsCode: '853810009999', coo: 'UAE', itemCode: 'INF-ENC-2R16M', description: '1200H x 600W x 200D Single Door Compact Enclosure IP65 (Cust Ref: ER-ENC-200)', qty: 35, unitPrice: 460.00, total: 16100.00 },
    ]
  },
];
